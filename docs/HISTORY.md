...
| Unnumbered desktop catalog | Runnable local Tauri 2/React read-only catalog browser over three exact shared operations with a dual-layer allowlisted bridge and no semantic/workspace mutation authority | Not committed | `apps/schuss_desktop/`, `docs/DESKTOP_UI_BOUNDARY.md`, `docs/tasks/ui-desktop-read-only-catalog.md`, focused UI/bridge tests |
