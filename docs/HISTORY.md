...
| Unnumbered desktop workspace shell | Always-on canvas, contextual Objects/Patches drawers, persistent local projects-root preference, core-owned project browsing/creation, and eager native core startup | Not committed | record set `schuss-record-set-000027@1`, `docs/tasks/ui-desktop-workspace-shell.md`, `packages/schuss_core/workspace_library.py`, `apps/schuss_desktop/` |
