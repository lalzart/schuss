...
- `architecture-audit.md` records the observed legacy Java loading and
  resolution boundary.
- `content-sources.md` specifies factual source discovery.
- `raw-catalog-spec.md` specifies the retained raw snapshot.
